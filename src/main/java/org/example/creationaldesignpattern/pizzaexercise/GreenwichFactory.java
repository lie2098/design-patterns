...
import org.example.creationaldesignpattern.pizzaexercise.pizza.VeggiePizza;

public class GreenwichFactory extends PizzaFactory {
  ...
  public Cheese createCheese() {
    return new MargheritaCheese(false);
  }
}
